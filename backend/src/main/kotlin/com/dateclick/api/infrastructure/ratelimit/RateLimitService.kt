...
class RateLimitService {
    ...
    fun checkRateLimit(sessionId: String, method: String, endpoint: String) {
        ...
        synchronized(counter) {
            ...
            logger.debug(
                ...
                sessionId, "$method:$normalizedEndpoint", counter.count.get(), rule.limit
            )
        }
    }
    ...
    private fun findMatchingRule(method: String, normalizedEndpoint: String): RateLimitRule {
